...
export const metadata: Metadata = {
  title: "Plans & Pricing - BillEazzy",
  description: "Choose the perfect plan for your business needs. From trial plans to annual subscriptions, find the right billing solution for you.",
};
...
export default function PlansPage() {
  return (
    <section className="overflow-hidden pt-32 pb-16 md:pt-20 md:pb-20 lg:pt-28 lg:pb-28">
