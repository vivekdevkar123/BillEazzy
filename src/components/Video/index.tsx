      ...
      <section className="relative z-10 py-16 md:py-20 lg:py-28">
        <div className="container">
          <SectionTitle
            ...
            paragraph="The following video is a demonstration of how you can use our application. Watch to see how easy it is to generate bills, manage inventory, and access reports with BillEazzy."
            center
            mb="80px"
          />
        </div>
